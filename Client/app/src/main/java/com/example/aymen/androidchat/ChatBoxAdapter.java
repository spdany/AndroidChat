...
//        if(m.getNickname().equals(Constants.name)){
//            holder.alert.setTextColor(ContextCompat.getColor(, R.color.alertGreen));
//        }

        holder.nickname.setText(m.getNickname() +" : ");
        holder.message.setText(m.getMessage());
        holder.message.setTextColor(Color.parseColor(Constants.coloursMap.get(m.getNickname())));
        holder.nickname.setTextColor(Color.parseColor(Constants.coloursMap.get(m.getNickname())));
